...
public abstract class Strategy extends Util implements QuoteListener, DealListener {
    ...
    OrderExe order(double pri, boolean buy, Date d, String otag) throws Exception {
    ...
    abstract OrderExe newOrderExe(double pri, boolean buy, Date date, String otag) throws Exception;
